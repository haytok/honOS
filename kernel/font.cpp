...
// 指定した文字の字形を face オブジェクトに読み出す関数
// face->glyph->bitmap にグリフが格納される。
...
std::pair<char32_t, int> ConvertUTF8To32(const char* u8) {
  ...
  case 4:
    return { // 1111 xxxx と 10xx xxxx と 10xx xxxx と 10xx xxxx
